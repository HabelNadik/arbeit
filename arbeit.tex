...
1AWR & 2.40.100.10  \\
1NGL & 2.40.128.20  \\
1N7V & 2.105.10.10  \\ % riesiges Virusprotein
7TIM & 3.20.20.70   \\
1NEY & 3.20.20.70   \\
2V5L & 3.20.20.70   \\
1V3Z & 3.30.70.100  \\
...
Da \textit{Graphlets} in den Experimenten von Pruzlj et al und Shervashidze et auf gro"se Graphen angewandt wurden, bietet es sich an, sie auch auf gro"se PRotein komplexe anzuwenden und bei kleinen Proeinen den Aminsos\"auregraphen zu verwenden. So kann man (hoffentlich) das Problem der d\"unn besetzten Graphen umgehen und f\"ur verschiedene GR\"o"sen von Graphen relevante Ergebnisse erzielen. Daf\"ur muss ein Datensatz aus gr\"o"sen PRoteinkomplexen mit bekannter struktureller \"Ahnlichkeit zusammengestellt werden.
