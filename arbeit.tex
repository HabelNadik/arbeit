...
Zus\"atzlich zu den \textit{Graphlets} bis zur Gr\"o"se 5 berechnet der \texttt{graphletAnalyser} markierte \textit{Graphlets} mit bis zu 3 Knoten. Dabei werden zun\"achst alle Markierungen die kombinatorisch m\"oglich sind berechnet und die entsprechenden \textit{Graphlets} werden gez\"ahlt.
...
\begin{figure}[h]
\includegraphics[width = \linewidth]{graphletAnalyserUMLv1.jpg}
\caption{UML-Diagramm von \texttt{graphletAnalyser}}
\label{fig:uml}
\end{figure}
